...
export const Tiles: Record<string, Tile> = {
  ...
  nier_town_door_in_1: {
    id: "nier_town_door_in_1",
    name: "Door",
    walkable: true,
    image: "/assets/tiles/warps/wooddoorinstonebick.png",
    onEnter: {
      type: "warp",
      targetMap: "blacksmithHouse",
      x: 3,
      y: 6,
    },
  },
  nier_town_door_out_1: {
    id: "nier_town_door_out_1",
    name: "Door",
    walkable: true,
    image: "/assets/tiles/warps/wooddoorinstonebick.png",
    onEnter: {
  ...
  nier_town_door_in_2: {
    id: "nier_town_door_in_2",
    name: "Door",
    walkable: true,
    image: "/assets/tiles/warps/wooddoorinstonebick.png",
    onEnter: {
      type: "warp",
      targetMap: "merchantHouse",
      x: 4,
      y: 8,
    },
  },
  nier_town_door_out_2: {
    id: "nier_town_door_out_2",
    name: "Door",
    walkable: true,
    image: "/assets/tiles/warps/wooddoorinstonebick.png",
    onEnter: {
  ...
  nier_town_door_in_3: {
    id: "nier_town_door_in_3",
    name: "Door",
    walkable: true,
    image: "/assets/tiles/warps/wooddoorinstonebick.png",
    onEnter: {
      type: "warp",
      targetMap: "farmerHouse",
      x: 4,
      y: 8,
    },
  },
  nier_town_door_out_3: {
    id: "nier_town_door_out_3",
    name: "Door",
    walkable: true,
    image: "/assets/tiles/warps/wooddoorinstonebick.png",
    onEnter: {
  ...
  nier_town_door_out_4: {
    id: "nier_town_door_out_4",
    name: "Door",
    walkable: true,
    image: "/assets/tiles/warps/wooddoorinstonebick.png",
    onEnter: {
